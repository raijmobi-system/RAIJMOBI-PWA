...
// 1. Definição dos tipos de modais que podem aparecer nesta tela
...
export default function Home() {
  ...
  const rideCards = [
    ...
    <CardComponent
      ...
      extraContent={
        <Flex>
          {/* 4. Aqui mudamos a ação de clique para ativar a view de detalhes */}
          <IconButton 
            variant='detail' 
            size='full' 
  ...
  // 5. Função auxiliar para decidir dinamicamente o título do modal
  const getModalTitle = () => {
